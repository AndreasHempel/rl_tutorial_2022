...
fn ui_example_system(
    ...
    occupied_screen_space.left = egui::SidePanel::left("left_panel")
        ...
        .show(egui_context.ctx_mut(), |ui| {
            ui.colored_label(Color32::WHITE, occupied_screen_space.left.to_string());
        })
        .response
        .rect
        .width();
    occupied_screen_space.right = egui::SidePanel::right("right_panel")
        .resizable(true)
        .show(egui_context.ctx_mut(), |ui| {
            ui.colored_label(Color32::WHITE, occupied_screen_space.right.to_string());
        })
        .response
        .rect
        .width();
    occupied_screen_space.top = egui::TopBottomPanel::top("top_panel")
        .resizable(true)
        .show(egui_context.ctx_mut(), |ui| {
            ui.colored_label(Color32::WHITE, occupied_screen_space.top.to_string());
        })
        .response
        .rect
        .height();
    occupied_screen_space.bottom = egui::TopBottomPanel::bottom("bottom_panel")
        .resizable(true)
        .show(egui_context.ctx_mut(), |ui| {
            ui.colored_label(Color32::WHITE, occupied_screen_space.bottom.to_string());
        })
        .response
        .rect
        .height();
